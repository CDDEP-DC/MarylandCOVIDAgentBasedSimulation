...
class GlobalLocationSetup:
    def __init__(self, globalId, populationAmt, HHSizeDist, HHSizeAgeDist, DiseaseParameters, LocalIdentification, RegionalIdentification,ProportionLowIntReduction,NursingFacilities,TransProb,TransProbLow):
